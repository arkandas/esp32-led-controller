...
function updateDeviceState(data) {
    deviceState = {
        ...
        sensorAvailable: data.sensorAvailable
    };
}
...
function updateDeviceTitle() {
    ...
    deviceTitle.textContent = deviceState.deviceName || 'ESP32 LED Controller V2';
}
...
function updateRGBDisplayFromState() {
    if (!deviceState.isPoweredOn) {
        ...
        const presetRGB = {
            ...
            6: [0, 255, 255],   // Cyan
            7: [255, 165, 0],   // Orange
            8: [255, 255, 255], // Bright White
            9: [128, 128, 128]  // Effects (grey placeholder)
        };
